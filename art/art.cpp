...
art_tree *new_art_tree() {
    art_tree *_new_art_tree = new art_tree;
    art_tree_init(_new_art_tree);
    return _new_art_tree;
}
 ...
 */
void *art_get(const art_tree *t, const unsigned char *key, int key_len) {
    art_node **child;
    art_node *n = t->root;
 ...
 */
void *art_put(art_tree *t, const unsigned char *key, int key_len, void *value) {
    int old_val = 0;
